...
import EducationalAdminClient from "./educational-admin-client";

export default async function AdminEducationalPage() {
          ...
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm md:text-base text-white/70 mt-1">
                Gerencie artigos educacionais
              </p>
            </div>
          </div>
        </div>

        <EducationalAdminClient adminEmail={adminEmail} />
      </div>
    </div>
  );
}